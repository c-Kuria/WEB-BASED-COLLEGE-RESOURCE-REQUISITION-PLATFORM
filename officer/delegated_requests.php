...
$officerResult = mysqli_stmt_get_result($stmt);
...
JOIN requisitions r ON ra.requisition_id = r.requisition_id
JOIN clubs c ON r.club_id = c.club_id
JOIN resources res ON r.resource_id = res.resource_id
WHERE ra.officer_id = $officer_id
AND ra.assigned_as = 'Proxy'
...
<div class="main">
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <a class="btn" href="review_request.php?id=<?= $row['approval_id']; ?>">Review</a>
            </td>
        </tr>
        <?php } ?>
    </table>
